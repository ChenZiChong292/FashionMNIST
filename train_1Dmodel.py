...
from model import Classification1DModel
import torch
import torchvision
...
def model1d(mode):
    ...
    if mode == 'train':
        ...
        accuracy_1D, conf_mat = calculate_test_accuracy('1D', test_loader, 10)
        print('The accuracy of 1Dmodel on test dataset is: ' + str(accuracy_1D) + '%')
        print('The confusion matrices of 1Dmodel on test dataset is as follows:')
